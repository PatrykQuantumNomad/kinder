...
```bash
INIT=$(node "/Users/patrykattc/work/git/kinder/.cursor/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/patrykattc/work/git/kinder/.cursor/get-shit-done/bin/gsd-tools.cjs" commit \
