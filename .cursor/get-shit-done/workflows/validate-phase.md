...
```
Agent(
  prompt="Read /Users/patrykattc/work/git/kinder/.cursor/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/patrykattc/work/git/kinder/.cursor/get-shit-done/templates/VALIDATION.md`
