...
<required_reading>
@/Users/patrykattc/work/git/kinder/.cursor/get-shit-done/references/user-story-template.md
@/Users/patrykattc/work/git/kinder/.cursor/get-shit-done/references/spidr-splitting.md
@/Users/patrykattc/work/git/kinder/.cursor/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/Users/patrykattc/work/git/kinder/.cursor/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `conversational prompting` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/Users/patrykattc/work/git/kinder/.cursor/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/Users/patrykattc/work/git/kinder/.cursor/get-shit-done/references/spidr-splitting.md`. Briefly:
