...
- **Global scope**: `/Users/patrykattc/work/git/kinder/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/patrykattc/work/git/kinder/.cursor/notes/`)
...
2. Glob `/Users/patrykattc/work/git/kinder/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/Users/patrykattc/work/git/kinder/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/patrykattc/work/git/kinder/.cursor/notes/` — works in any directory
