...
```bash
INIT=$(node "/Users/patrykattc/work/git/kinder/.cursor/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/patrykattc/work/git/kinder/.cursor/get-shit-done/templates/spec.md.
