...
- Usage: Reference from command with `@/Users/patrykattc/work/git/kinder/.cursor/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/patrykattc/work/git/kinder/.cursor/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/patrykattc/work/git/kinder/.cursor/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
