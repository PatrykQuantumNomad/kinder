...
Intel system is disabled. To activate:
  ...
  node /Users/patrykattc/work/git/kinder/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /Users/patrykattc/work/git/kinder/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /Users/patrykattc/work/git/kinder/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /Users/patrykattc/work/git/kinder/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
