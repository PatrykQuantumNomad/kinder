...
<reference>
@/Users/patrykattc/work/git/kinder/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/patrykattc/work/git/kinder/.claude/get-shit-done/references/user-profiling.md` to load:
