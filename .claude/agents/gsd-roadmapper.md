...
Reference full template: `/Users/patrykattc/work/git/kinder/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/patrykattc/work/git/kinder/.claude/get-shit-done/templates/state.md`.
