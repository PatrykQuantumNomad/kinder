...
INSTALL_JS_GLOBAL="/Users/patrykattc/work/git/kinder/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/patrykattc/work/git/kinder/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
