...
```
Task(
  prompt="Read /Users/patrykattc/work/git/kinder/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/patrykattc/work/git/kinder/.claude/get-shit-done/templates/SECURITY.md`
