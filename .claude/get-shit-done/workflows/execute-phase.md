...
- Executor agents omit extended deviation rule examples and checkpoint examples from inline prompt — load on-demand via @/Users/patrykattc/work/git/kinder/.claude/get-shit-done/references/executor-examples.md
- Planner agents omit extended anti-pattern lists and specificity examples from inline prompt — load on-demand via @/Users/patrykattc/work/git/kinder/.claude/get-shit-done/references/planner-antipatterns.md
   ...
   **Sequential dispatch for parallel execution (waves with 2+ agents):**
   ...
   Agent(
     ...
     prompt="
       ...
       @/Users/patrykattc/work/git/kinder/.claude/get-shit-done/references/worktree-path-safety.md
       ${CONTEXT_WINDOW < 200000 ? '' : '@/Users/patrykattc/work/git/kinder/.claude/get-shit-done/references/executor-examples.md'}
       </execution_context>
