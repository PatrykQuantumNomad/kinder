...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/Users/patrykattc/work/git/kinder/.claude/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/Users/patrykattc/work/git/kinder/.claude/get-shit-done/workflows/transition.md`.
