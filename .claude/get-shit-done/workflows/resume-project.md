...
<required_reading>
@/Users/patrykattc/work/git/kinder/.claude/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/Users/patrykattc/work/git/kinder/.claude/get-shit-done/bin/gsd-tools.cjs" init resume)
