...
- [ ] **Phase 58: Live UAT Closure for Phase 47 + 51** - Run and record live smoke tests against rebuilt v2.4 binary for both deferred UAT items. (Phase 57.3 LANDED 2026-05-17 — cert-regen recovery works end-to-end on IPv4 + IPv6 + dual-stack; Phase 57.4 LANDED 2026-05-19 — IPAM probe --privileged fix restores ip-pin as default HA path; both 57.3+57.4 gates satisfied. Phase 58 unblocked: awaiting `bash hack/uat-47-ha-smoke.sh` test_09 re-run against post-fix binary)
...
| 58. Live UAT Closure for Phase 47 + 51 | v2.4 | 0/2 | UNBLOCKED (57.3+57.4 gates satisfied; awaiting test_09 re-run) | - |
